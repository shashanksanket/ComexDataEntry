					...
					<b-table style="width:100%;" ref="data" class="position-relative" :items="searchRes" responsive
						...
						<template #cell(Actions)="data">
							...
							<b-dropdown variant="link" no-caret :right="$store.state.appConfig.isRTL">
								...
								<!-- <b-dropdown-item @click="editModal = !editModal">
...
import {
	BSidebar, BDropdown, BDropdownItem, BTable, BModal, BForm, BFormFile, BFormGroup, BFormInput, BFormInvalidFeedback, BButton, BFormSelect, BFormCheckbox
} from 'bootstrap-vue'
