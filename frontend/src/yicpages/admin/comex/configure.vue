			...
			<div class="root5" style="">
				<template>
					...
					<validation-observer ref="registerForm">
						<b-form class="form" @submit.prevent>
							...
							<b-form-group style="margin:10px; display: flex; flex-direction: column;" id="fieldset-1"
								label="Enter OLT Id" label-for="input-1">
								<b-form-input id="input-2" v-model="OltId"></b-form-input>
							</b-form-group>
							<b-form-group style=" margin:10px; display: flex; flex-direction: column;" id="fieldset-1"
								label="Enter OLT Name" label-for="input-1">
								<b-form-input id="input-2" v-model="OltName"></b-form-input>
							</b-form-group>
							<b-form-group style=" margin:10px; display: flex; flex-direction: column;" id="fieldset-2"
								label="Pon Number" label-for="input-2">
								<b-form-input id="input-2" v-model="ponNo"></b-form-input>
							</b-form-group>
							<b-form-group style=" margin:10px; display: flex; flex-direction: column;" id="fieldset-2"
								label="GM" label-for="input-2">
								<b-form-input id="input-2" v-model="GM"></b-form-input>
							</b-form-group>
							<b-form-group style=" margin:10px; display: flex; flex-direction: column;" id="fieldset-2"
								label="Start Range" label-for="input-2">
								<b-form-input id="input-2" v-model="startRange"></b-form-input>
							</b-form-group>
							<b-form-group style=" margin:10px; display: flex; flex-direction: column;" id="fieldset-2"
								label="End Range" label-for="input-2">
								<b-form-input id="input-2" v-model="endRange"></b-form-input>
							</b-form-group>



							<b-button v-if="($mq === 'largeDevices' || $mq === 'mediumDevices')" type="submit"
								variant="primary" @click="check()" style="margin: 20px; width:300px">Submit</b-button>
						...
						<b-modal ok-title="Continue" @ok="onSubmit()" v-model="danger">
							<p>The OltId {{ this.OltId }} and OltName {{ this.OltName }} combination dosen't exist in the
								Database</p>
							<p>Continue to confirm!</p>
							<p>Cancel to abort!</p>
				...
				<div class="configData">
					...
					<b-table :current-page="currentPage" id="table" :per-page="perPage" style="width:100%;" ref="data"
						class="position-relative" :items="configData" responsive :fields="tableColumns" primary-key="id"
					...
					<b-pagination v-model="currentPage" :total-rows="configData.length" :per-page="perPage"
